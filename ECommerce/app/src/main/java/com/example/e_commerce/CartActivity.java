        ...
        FirebaseRecyclerAdapter<Cart,CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart,CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
               ...
               holder.txtProductName.setText(model.getPname());
                ...
                int oneTypeProductTPrice=(Integer.parseInt(model.getPrice().replaceAll("\\tk+",""))) * Integer.parseInt(model.getQuantity());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("Shipped")){
                        ...
                        txtMsg1.setText("Congratulation, your final order has been Shipped succssfully, soon you will receive your order at your door step.");
